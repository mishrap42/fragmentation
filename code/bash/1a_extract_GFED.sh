...
# ==============================================================================
# STAGE 1a: GFED5 Burned Area Extraction (Sub-tile level)
# Extracts GFED5 burned area for each sub-tile, processing all years
#
# Array size: 344 sub-tiles (same as Stage 0 and 0c)
#
...
R_SCRIPT="code/build/1a_extract_GFED.R"
