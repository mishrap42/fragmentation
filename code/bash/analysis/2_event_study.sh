...
# ==============================================================================
# Event Study Analysis: Protected Area Designation Effects
# Estimates TWFE model and generates event study plot
# ==============================================================================
...
R_SCRIPT="code/analysis/2_event_study.R"
