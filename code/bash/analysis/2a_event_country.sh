...
# ==============================================================================
# 2a_event_country.sh - Per-Country Event Study
# Each array task: processes event study for a single country
#
# Array size: 128 (overestimate; R script handles out-of-range gracefully)
# Memory: 16G per task (panel loading for treated cells)
# ==============================================================================
...
R_SCRIPT="code/analysis/2a_country_event_study.R"
