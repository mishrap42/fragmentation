...
# ==============================================================================
# MatchIt Matching Analysis: Protected Area Designation Effects
# Matches treated cells to controls, then runs TWFE event study
# ==============================================================================
...
R_SCRIPT="code/analysis/3_matching.R"
