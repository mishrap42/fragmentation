...
# ==============================================================================
# 3a_matching.sh - Per-Country Matching + Event Study
# Each array task: matches treated/control cells, runs TWFE, generates figure
#
# Array size: 128 (overestimate; R script handles out-of-range gracefully)
# Memory: 16G per task (panel loading for matched cells)
# ==============================================================================
...
R_SCRIPT="code/analysis/3a_matching.R"
