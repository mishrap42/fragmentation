...
# ==============================================================================
# 4b_pooled_event_study.sh - Treatment-area-weighted pooled graphs
# Single job (no array). Reads the consolidated synthetic-control output and
# writes, globally and per country:
#   - pooled_levels_*.png        (area-weighted observed vs synthetic, levels)
#   - pooled_event_study_*.png   (area-weighted gap event study + PA counts)
#
# Prerequisite: run 4_synthetic_control.sh (all countries) then
#               4a_consolidate_synth.R first, so the consolidated CSVs exist.
# ==============================================================================
...
R_SCRIPT="code/analysis/4b_pooled_event_study.R"
