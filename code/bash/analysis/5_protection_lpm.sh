...
# ==============================================================================
# 5_protection_lpm.sh - PA selection: accessibility regression + balance table
# Single job (no array). Reads the TMF panel, fits the log-odds-of-forest-use
# accessibility regression, builds the inclusive value, and writes:
#   - accessibility_regression.tex   (first-stage regression)
#   - balance_ever_vs_never.tex      (AER booktabs balance table)
#
# Prerequisite: the final panel exists.
# ==============================================================================
...
R_SCRIPT="code/analysis/5_protection_lpm.R"
